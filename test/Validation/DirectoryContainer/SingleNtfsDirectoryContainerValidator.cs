namespace DataMigratorTest.Validation.DirectoryContainer
{
    ...
    public class SingleNtfsDirectoryContainerValidator :
        SingleDirectoryContainerValidatorBase<NtfsDirectoryContainerInfo, NtfsDirectoryHeader, NtfsFileHeader>
    {
        private readonly NtfsContainerValidator _ntfsValidator;

        public SingleNtfsDirectoryContainerValidator()
        {
