namespace DataMigrator.Container.Base.Header
{
    ...
    public sealed class StartHeader : Header, IStartHeader
    {
        ...
        /// </summary>
        /// <param name="container">The serialized migration container.</param>
        /// <returns>The deserialized StartHeader of the specified migration container.</returns>
        public static StartHeader Extract(FileInfo container)
        {
            if (!container.IsMigrationContainer()) throw new InvalidDataException("The specified file is no file container.");
